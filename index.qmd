...
head(wetldunion)
wetldpallette <- colorNumeric(palette = "inferno", domain = wetldunion$Wetld_Wgt, na.color = "transparent")
...
#  addLegend(pal = wetldpallette, values = values(wetldsum), title = "Wetland Proximity values", opacity = 1) %>%
